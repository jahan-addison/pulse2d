...
# compile game sources to ARM assembly
make -f Makefile.teensy asm
# section map: region, VMA, size for every output section
make -f Makefile.teensy sections
# same, including small sections
make -f Makefile.teensy sections SECTIONS_ALL=1
# print the linker script memory regions and section -> region table
make -f Makefile.teensy ldscript
```
...
![demo](/docs/demo/pulse2d-demo-parallax-backgrounds.mp4)
